    ...
    FestUploadFormComponent.prototype.onFestSubmit = function () {
        ...
        for (var item in this.festForm.value) {
            if (item == "image") {
                ...
                if (this.festForm.value[item] != null) {
                    var datesInput = document.getElementById("sdate").toString();
                    var parsedDate = datesInput.substring(0, 10);
                    this.festForm.value[item] = parsedDate;
                }
            }
            else if (item == "end_date") {
                if (this.festForm.value[item] != null) {
                    var datesInput = document.getElementById("edate").toString();
                    var parsedDate = datesInput.substring(0, 10);
                    this.festForm.value[item] = parsedDate;
                }
            }
                ...
                if (this.festForm.value[item] != null) {
                    var datesInput = document.getElementById("ev_date").toString();
                    var parsedDate = datesInput.substring(0, 10);
                    this.festForm.value[item] = parsedDate;
                }
            }
