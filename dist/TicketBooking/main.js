...
function getAuthServiceConfigs() {
    return new angularx_social_login__WEBPACK_IMPORTED_MODULE_15__["AuthServiceConfig"]([
        {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [{
                ...
                }, _app_service__WEBPACK_IMPORTED_MODULE_22__["AppService"], _auth_guard_service__WEBPACK_IMPORTED_MODULE_23__["AuthGuardService"], _authentication_service__WEBPACK_IMPORTED_MODULE_32__["AuthenticationService"], _orgauth_service__WEBPACK_IMPORTED_MODULE_36__["OrgauthService"]],
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.paymentList = function () {
        //  let headerOptions = new Headers({ 'Content-Type': 'application/json'});
        //  let requestOptions = new RequestOptions({ method: RequestMethod.Post, headers: headerOptions });
        return this.http.get(this._organizationUrl + "payment/list/").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (x) { return x.json(); }));
    };
...
module.exports = "<app-userheader></app-userheader>\n<div class=\"inner-ban\">\n  <img src=\"assets/images/inner-ban.jpg\" alt=\"\">\n</div>\n<section class=\"orgdashboard\">\n  <div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-md-12 text-center\">\n        <h2>dashboard</h2>\n      </div>\n      <div class=\"col-md-4\">\n        <div class=\"profile-sec\">\n          <h3>your profile</h3>\n          <img id=\"googleImg\" alt=\"\">\n          <ul>\n            <li>{{socialData.firstName}}</li>\n            <li>{{socialData.lastName}}</li>\n            <li>{{socialData.email}}</li>\n            <!--<li><a href=\"#\">Edit</a></li>-->\n          </ul>\n        </div>\n\n      </div>\n      <div class=\"col-md-8\">\n        <div class=\"profile-decp2\">\n          <ul>\n            <li class=\"active\"><a data-toggle=\"tab\" href=\"#pro-1\">Booked Tickets </a></li>\n            <li><a data-toggle=\"tab\" href=\"#pro-2\">liked events</a></li>\n          </ul>\n          <div class=\"tab-content eventDetails\">\n            <div id=\"pro-1\" class=\"tab-pane fade in active bookedTickets\">\n              <!--<h3>your tickets</h3>-->\n              <div *ngIf=\"bookedEvents\">\n                <div>\n                  <div *ngFor=\"let bookFest of bookedEvents\">\n                    <div>\n                      <div class=\"row eventDetailsCard\">\n                        <div class=\"col-md-5 text-center\">\n                          <img width=\"150\"\n                               src=\"https://cdn4.iconfinder.com/data/icons/let-s-party/756/dance_party_drunk_disco_birthday_celebrate_pub-512.png\"\n                               alt=\"404\">\n                          <div>\n                            <h3>{{bookFest.name}}</h3>\n                            <p class=\"eventDateVenue\">SJBIT, Jayanagar 6th Block,Bangalore\n                              on {{bookFest.booking_date}}</p>\n                            <p class=\"eventTime\">at 7:00 a.m.</p>\n                          </div>\n                        </div>\n                        <div class=\"col-md-7 eventFesterDetails\">\n                          <h1 class=\"col-md-12\">Swapnil Kumar</h1>\n                          <dt class=\"col-md-6 col-sm-6 col-xs-6\">Paid</dt>\n                          <dd class=\"col-md-6 col-sm-6 col-xs-6\"> &#8377; {{bookFest.ticket_price}}</dd>\n\n                          <dt class=\"col-md-6 col-sm-6 col-xs-6\">Ticket ID</dt>\n                          <dd class=\"col-md-6 col-sm-6 col-xs-6\">1523</dd>\n\n                          <dt class=\"col-md-6 col-sm-6 col-xs-6\">Coordinator</dt>\n                          <dd class=\"col-md-6 col-sm-6 col-xs-6\">Raghav, 910863783</dd>\n\n                          <dt class=\"col-md-6 col-sm-6 col-xs-6\">Others</dt>\n                          <dd class=\"col-md-6 col-sm-6 col-xs-6\">Bla bL bal</dd>\n                        </div>\n                      </div>\n                    </div>\n                  </div>\n                </div>\n                <div id=\"pro-2\" class=\"tab-pane fade\">\n                  <h3>liked events</h3>\n                  <div *ngIf=\"likedFest\">\n                    <div *ngFor=\"let likeFest of likedFest\">\n                      <div class=\"sec-1\">\n                        <div class=\"col-md-4\">\n                          <h2>Fest Name </h2><h4>{{likeFest.name}} </h4>\n                        </div>\n                        <div class=\"col-md-4 text-right\">\n                          <h2>Start Date </h2> <h4> {{likeFest.date}}</h4>\n                        </div>\n                      </div>\n                    </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</section>\n<app-footer></app-footer>\n"
...
module.exports = ".eventDetails {\n  background: #FFFFFF; }\n  .eventDetails .eventDetailsCard {\n    border: 1px solid lightgrey;\n    background: #FFFFFF;\n    margin-right: 15px;\n    margin-left: 15px;\n    padding: 10px 0 10px 0;\n    color: #000;\n    margin-top: 10px; }\n  .eventDetails .eventDetailsCard .eventDateVenue {\n      margin-bottom: 0; }\n  .eventDetails .eventDetailsCard .eventTime {\n      margin-bottom: 0; }\n  .eventDetails .eventDetailsCard .eventUserDetails {\n      color: #1c1c1c; }\n  .eventDetails .eventDetailsCard .eventFesterDetails > dt {\n      font-size: 16px;\n      padding-right: 0; }\n  .eventDetails .eventDetailsCard .eventFesterDetails > dd {\n      font-size: 18px;\n      padding-right: 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        var image = document.getElementById('googleImg');
...
var FestUploadFormComponent = /** @class */ (function () {
    ...
    FestUploadFormComponent.prototype.ngOnInit = function () {
        this.festForm = this.formBuilder.group({
            ...
            start_date: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](Date, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            end_date: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](Date, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
    ...
    FestUploadFormComponent.prototype.onKeydown = function (e) {
        e.preventDefault();
    };
...
var FestComponent = /** @class */ (function () {
    ...
    Object.defineProperty(FestComponent.prototype, "authenticationServicefn", {
        get: function () {
...
module.exports = "<div *ngIf=\" this.authenticationServicefn.orgExist\">\n    <app-organizationheader></app-organizationheader>\n</div>\n<div *ngIf=\" this.authenticationServicefn.userExist\">\n    <app-userheader></app-userheader>\n</div>\n\n<div *ngIf=\" this.authenticationServicefn.userExist == undefined &&  this.authenticationServicefn.orgExist == undefined\">\n    <app-header></app-header>\n</div>\n<!-- <div class=\"inner-ban\">\n    <img src=\"assets/images/inner-ban.jpg\" alt=\"\">\n</div> -->\n\n<section class=\"festspecific-page\">\n    <div class=\"container\">\n        <div class=\"row\">\n            \n            <div class=\"col-md-9\" *ngIf=\"this.festDetails\">\n                <div class=\"fest-decp\">\n                        <div class=\"row\">\n                                <div class=\"col-md-12\">\n                                    <img style=\"width:100%; margin-bottom: 2%;\" src=\"{{this.festDetails.image}}\">\n                                </div>\n                            </div>\n                    <div class=\"row\">\n                    <div class=\"col-md-4 col-md-offset-4\"><h2>{{this.festDetails.name}}</h2></div><div class=\"fest-type col-md-2 pull-right text-center\"><h4>{{this.festDetails.fest_type}}</h4></div>\n                    </div>\n                    <div class=\"sec2\">\n                        <div class=\"row text-center\">\n                            <!-- <div class=\"col-md-9\"> -->\n                            <h3>description</h3>\n                            <p></p>\n                            <p>{{this.festDetails.description}}</p>\n                        </div>\n                    </div>\n                    <!-- <div class=\"sec2\">\n                        <div class=\"row text-center\">\n                            <h3>Contact Details</h3>\n                            <p></p>\n                            <div class=\"col-md-6\">\n                                <h4>Main Coordinator</h4>\n                                <p></p>\n                                <p>{{this.festDetails.manager_name}}</p>\n                                <p>{{this.festDetails.manager_phone}}</p>\n                                <p>{{this.festDetails.manager_email}}</p>\n                            </div>\n                            <div class=\"col-md-6\">\n                                <h4>Secondary Coordinator</h4>\n                                <p></p>\n                                <p>{{this.festDetails.sec_manager_name}}</p>\n                                <p>{{this.festDetails.sec_manager_phone}}</p>\n                            </div>\n                        </div>\n                    </div> -->\n                    <!--<div class=\"sec2\">\n            <h4>update</h4>\n          </div>-->\n                    <!-- <div class=\"sec3\">\n            <img src=\"http://sckana.net/New%20Images/events.jpg\" alt=\"\">\n            <h4>Name</h4>\n            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Animi, necessitatibus quos. Impedit quae harum, omnis, ut, ex hic cupiditate voluptatem ab esse eaque eum libero asperiores dolorum et distinctio molestias.</p>\n          </div>-->\n                    <div class=\"sec4\">\n                        <h4>events</h4>\n                        <div *ngFor=\"let eventDetails of this.festDetails.events\">\n                            <div class=\"col-md-6 col-sm-6\">\n                                <div class=\"pricingTable\">\n                                    <div class=\"pricingTable-header\">\n                                        <span class=\"heading\">\n                                                <div class=\"event-type col-md-12 text-center\"><h5>{{eventDetails.event_type}}</h5></div>\n                                                <div class=\"row\">\n                                                        <div class=\"col-md-6 col-md-offset-3\"><h3>{{eventDetails.event_name}}</h3></div>\n                                                    </div>\n                                        </span>\n                                    </div>\n                                    <div class=\"row\">\n                                        <img height=150 src=\"assets/images/{{eventDetails.event_type}}.png\">\n                                    </div>\n                                    <!-- <div class=\"pricingContent\">\n                                        <ul>\n                                            <li>{{eventDetails.event_date}}, {{eventDetails.event_time}}</li>\n                                        </ul>\n                                        <h5>Description:</h5>\n                                        <ul>\n                                            <li>{{eventDetails.event_description}}</li>\n                                        </ul>\n                                        <ul>\n                                            <li>{{eventDetails.event_coordinator}}</li>\n                                        </ul>\n                                        <h5>Price:</h5>\n                                        <ul>\n                                            <li>{{eventDetails.ticket_price}}</li>\n                                        </ul>\n                                    </div> -->\n                                    <div class=\"pricingContent\">\n                                    <div class=\"row text-center\">\n                                        <p>{{eventDetails.event_description}}</p>\n                                    </div>\n                                    <hr>\n                                    <div class=\"row text-center\">\n                                        <div class=\"col-md-6\"><p>{{eventDetails.event_date}}</p></div>\n                                        <div class=\"col-md-6\"><p>{{eventDetails.event_time}}</p></div>\n                                    </div>\n                                    <div class=\"row text-center\">\n                                            <p>{{eventDetails.event_coordinator}}</p>\n                                    </div>\n                                    <div class=\"pricingTable-sign-up\">\n                                        <a role=\"button\" (click)=\"festDeatils(eventDetails)\" class=\"btn btn-block btn-default\">book</a>\n\n                                    </div>\n                                    </div>\n                                    <!-- BUTTON BOX-->\n                                </div>\n                            </div>\n                            <!-- <div class=\"clearfix\"></div> -->\n                        </div>\n                    </div>\n                    <!--end event-->\n                </div>\n            </div>\n            <div class=\"col-md-3\">\n                    <div class=\"left-sec\">\n                        <!--<img src=\"https://festevents.org/files/cache/c8c82a059994675fc46fb69d5ffbd02e_f3570.jpg\" alt=\"\">-->\n                        <!-- <img id=\"festImg\" alt=\"\"> -->\n                        <div *ngIf=\"this.festDetails\">\n                            <div class=\"row text-center\">\n                                <div class=\"col-md-12 contactus\">\n                                <h3>Contact Us</h3>\n                                </div>\n                            </div>\n                            <div class=\"col-md-10 col-md-offset-1\">\n                                <h4>Main Coordinator</h4>\n                                <p></p>\n                                <h5>{{this.festDetails.manager_name}}</h5>\n                                <h5>{{this.festDetails.manager_phone}}</h5>\n                                <h5>{{this.festDetails.manager_email}}</h5>\n                                <h4>Secondary Coordinator</h4>\n                                <p></p>\n                                <h5>{{this.festDetails.sec_manager_name}}</h5>\n                                <h5>{{this.festDetails.sec_manager_phone}}</h5>\n                            </div>\n                            <!-- <ul>\n                                <li>Date: {{this.festDetails.start_date}}</li>\n                                <li>website:{{this.festDetails.website}}</li>\n                            </ul> -->\n                            <h3>sponsors</h3>\n                            <div class=\"spon-img text-center\">\n                                <div *ngFor=\"let sponsorDetails of this.festDetails.sponsor\">\n                                    <ul>\n                                        <li *ngIf=\"sponsorDetails.sponsor_name\"><h5><span>{{sponsorDetails.sponsor_name}}</span></h5></li>\n                                        <img [src]=\"sponsorDetails.sponsor_picture\" alt=\"\">\n                                        <li *ngIf=\"sponsorDetails.caption\"><h5><span>{{sponsorDetails.caption}}</span></h5></li>\n                                    </ul>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n        </div>\n    </div>\n</section>\n<app-footer></app-footer>"
...
var FestspecificComponent = /** @class */ (function () {
    ...
    FestspecificComponent.prototype.getReadableDate = function (dateStr) {
        var dateModified = new Date(dateStr.toString());
    ...
    FestspecificComponent.prototype.ngOnInit = function () {
        ...
        this.authenticationService.festSepecificDetails(this.festID).subscribe(function (data) {
            ...
            _this.festDetails.start_date = _this.getReadableDate(_this.festDetails.start_date);
            if (_this.festDetails.events.length >= 1) {
                _this.festDetails.events.map(function (x) {
                    x.event_date = _this.getReadableDate(x.event_date);
                    if (x.ticket_price) {
    ...
    Object.defineProperty(FestspecificComponent.prototype, "authenticationServicefn", {
        get: function () {
            return this.authenticationService;
        },
        enumerable: true,
...
module.exports = "\n<!-- <div class=\"copy text-center\">\n\t<p>Copyright &copy; 2019 </p>\n</div> -->\n<style>\nfooter{\n\tposition: relative;\n\tbottom: 0;\n}\n.footer-distributed{\n\tbackground-color: #292c2f;\n\tbox-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.12);\n\tbox-sizing: border-box;\n\twidth: 100%;\n\ttext-align: left;\n\tfont: bold 16px sans-serif;\n\n\tpadding: 55px 50px;\n\tmargin-top: 80px;\n}\n\n.footer-distributed .footer-left,\n.footer-distributed .footer-center,\n.footer-distributed .footer-right{\n\tdisplay: inline-block;\n\tvertical-align: top;\n}\n\n/* Footer left */\n\n.footer-distributed .footer-left{\n\twidth: 40%;\n}\n\n/* The company logo */\n\n.footer-distributed h3{\n\tcolor:  #ffffff;\n\tfont: normal 36px 'Cookie', cursive;\n\tmargin: 0;\n}\n\n.footer-distributed h3 span{\n\tcolor:  #5383d3;\n}\n\n/* Footer links */\n\n.footer-distributed .footer-links{\n\tcolor:  #ffffff;\n\tmargin: 20px 0 12px;\n\tpadding: 0;\n}\n\n.footer-distributed .footer-links a{\n\tdisplay:inline-block;\n\tline-height: 1.8;\n\ttext-decoration: none;\n\tcolor:  inherit;\n}\n\n.footer-distributed .footer-company-name{\n\tcolor:  #8f9296;\n\tfont-size: 14px;\n\tfont-weight: normal;\n\tmargin: 0;\n}\n\n/* Footer Center */\n\n.footer-distributed .footer-center{\n\twidth: 35%;\n}\n\n.footer-distributed .footer-center i{\n\tbackground-color:  #33383b;\n\tcolor: #ffffff;\n\tfont-size: 25px;\n\twidth: 38px;\n\theight: 38px;\n\tborder-radius: 50%;\n\ttext-align: center;\n\tline-height: 42px;\n\tmargin: 10px 15px;\n\tvertical-align: middle;\n}\n\n.footer-distributed .footer-center i.fa-envelope{\n\tfont-size: 17px;\n\tline-height: 38px;\n}\n\n.footer-distributed .footer-center p{\n\tdisplay: inline-block;\n\tcolor: #ffffff;\n\tvertical-align: middle;\n\tmargin:0;\n}\n\n.footer-distributed .footer-center p span{\n\tdisplay:block;\n\tfont-weight: normal;\n\tfont-size:14px;\n\tline-height:2;\n}\n\n.footer-distributed .footer-center p a{\n\tcolor:  #5383d3;\n\ttext-decoration: none;;\n}\n\n\n/* Footer Right */\n\n.footer-distributed .footer-right{\n\twidth: 20%;\n}\n\n.footer-distributed .footer-company-about{\n\tline-height: 20px;\n\tcolor:  #92999f;\n\tfont-size: 13px;\n\tfont-weight: normal;\n\tmargin: 0;\n}\n\n.footer-distributed .footer-company-about span{\n\tdisplay: block;\n\tcolor:  #ffffff;\n\tfont-size: 14px;\n\tfont-weight: bold;\n\tmargin-bottom: 20px;\n}\n\n.footer-distributed .footer-icons{\n\tmargin-top: 25px;\n}\n\n.footer-distributed .footer-icons a{\n\tdisplay: inline-block;\n\twidth: 35px;\n\theight: 35px;\n\tcursor: pointer;\n\tbackground-color:  #33383b;\n\tborder-radius: 2px;\n\n\tfont-size: 20px;\n\tcolor: #ffffff;\n\ttext-align: center;\n\tline-height: 35px;\n\n\tmargin-right: 3px;\n\tmargin-bottom: 5px;\n}\n\n/* If you don't want the footer to be responsive, remove these media queries */\n\n@media (max-width: 880px) {\n\n\t.footer-distributed{\n\t\tfont: bold 14px sans-serif;\n\t}\n\n\t.footer-distributed .footer-left,\n\t.footer-distributed .footer-center,\n\t.footer-distributed .footer-right{\n\t\tdisplay: block;\n\t\twidth: 100%;\n\t\tmargin-bottom: 40px;\n\t\ttext-align: center;\n\t}\n\n\t.footer-distributed .footer-center i{\n\t\tmargin-left: 0;\n\t}\n\n}\n\n\n@media (max-height:800px){\n\tfooter { position: static; }\n\theader { padding-top:40px; }\n}\n</style>\n<footer class=\"footer-distributed\">\n\n\t\t<div class=\"footer-left\">\n\n\t\t\t<div class=\"col-md-6\"><a href=\"javascript:void(0);\"><img src=\"assets/images/logo2.png\" alt=\"\"></a></div>\n\t\t\t<div class=\"col-md-12\">\n\t\t\t<p class=\"footer-links\">\n\t\t\t\t<a href=\"#\">Home</a>\n\t\t\t\t·\n\t\t\t\t<a href=\"#\">Blog</a>\n\t\t\t\t·\n\t\t\t\t<a href=\"#\">Privacy Policy</a>\n\t\t\t\t·\n\t\t\t\t<a href=\"#\">About</a>\n\t\t\t\t·\n\t\t\t\t<a href=\"#\">Faq</a>\n\t\t\t\t·\n\t\t\t\t<a href=\"#\">Contact</a>\n\t\t\t</p>\n\n\t\t\t<p class=\"footer-company-name\">Festify Pvt. Ltd. &copy; 2019</p>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class=\"footer-center\">\n\n\t\t\t<div>\n\t\t\t\t<i class=\"fa fa-map-marker\"></i>\n\t\t\t\t<p><span>Banashankari 2nd Stage</span> Bangalore, Karnataka</p>\n\t\t\t</div>\n\n\t\t\t<div>\n\t\t\t\t<i class=\"fa fa-phone\"></i>\n\t\t\t\t<p>+91 9611990077</p>\n\t\t\t</div>\n\n\t\t\t<div>\n\t\t\t\t<i class=\"fa fa-envelope\"></i>\n\t\t\t\t<p><a href=\"mailto:support@festify.in\">info@festify.in</a></p>\n\t\t\t</div>\n\n\t\t</div>\n\n\t\t<div class=\"footer-right\">\n\n\t\t\t<p class=\"footer-company-about\">\n\t\t\t\t<span>About the company</span>\n\t\t\t\tWe aim to be the only festing solution you'll ever need. Hit us up with any queries. Grant us a mere 24 hours to assist you in the best possible way. Happy Festing!\n\t\t\t</p>\n\n\t\t\t<div class=\"footer-icons\">\n\n\t\t\t\t<a href=\"#\"><i class=\"fa fa-facebook\"></i></a>\n\t\t\t\t<a href=\"#\"><i class=\"fa fa-twitter\"></i></a>\n\t\t\t\t<a href=\"#\"><i class=\"fa fa-linkedin\"></i></a>\n\t\t\t\t<a href=\"#\"><i class=\"fa fa-github\"></i></a>\n\n\t\t\t</div>\n\n\t\t</div>\n\n\t</footer>"
...
var HeaderComponent = /** @class */ (function () {
    ...
    Object.defineProperty(HeaderComponent.prototype, "authenticationServiceFn", {
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(authenticationService, platformId, router) {
        var _this = this;
        this.authenticationService = authenticationService;
    ...
    Object.defineProperty(HomeComponent.prototype, "authenticationServicefn", {
        get: function () {
            return this.authenticationService;
        },
        enumerable: true,
    ...
    HomeComponent.prototype.createEvent = function () {
        this.router.navigate(['signup']);
    };
    ...
    HomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"], Object, _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], HomeComponent);
...
module.exports = ".participantsListDetails {\n  background: #FFFFFF; }\n  .participantsListDetails .participantsListCard {\n    border: 1px solid lightgrey;\n    background: #FFFFFF;\n    margin-right: 15px;\n    margin-left: 15px;\n    padding: 10px 0 10px 0;\n    color: #000;\n    margin-top: 10px; }\n  .participantsListDetails .participantsListCard .eventDateVenue {\n      margin-bottom: 0; }\n  .participantsListDetails .participantsListCard .eventTime {\n      margin-bottom: 0; }\n  .participantsListDetails .participantsListCard .eventUserDetails {\n      color: #1c1c1c; }\n  .participantsListDetails .participantsListCard .eventFesterDetails > dt {\n      font-size: 16px;\n      padding-right: 0; }\n  .participantsListDetails .participantsListCard .eventFesterDetails > dd {\n      font-size: 18px;\n      padding-right: 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var OrganizationDashboardComponent = /** @class */ (function () {
    ...
    OrganizationDashboardComponent.prototype.gettingPaymentData = function () {
        var _this = this;
        this.appService.paymentList().subscribe(function (data) {
            _this.paymentList = data;
            localStorage.setItem('payment', JSON.stringify(_this.paymentList));
        });
    };
    OrganizationDashboardComponent.prototype.gettingFestData = function () {
        ...
        this.appService.specificOrganizationList().subscribe(function (data) {
            ...
            image.setAttribute('src', _this.organizationList.image);
        });
    };
    ...
    OrganizationDashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./organization-dashboard.component.scss */ "./src/app/components/organization-dashboard/organization-dashboard.component.scss")]
        }),
...
var OrganizationsComponent = /** @class */ (function () {
    ...
    Object.defineProperty(OrganizationsComponent.prototype, "authenticationServicefn", {
        get: function () {
            return this.authenticationService;
        },
        enumerable: true,
    ...
    RegistrationComponent.prototype.onRegistrationSubmit = function () {
        ...
        if (this.registerForm.invalid) {
            ...
            this.appService.createOrganization(this.registerForm)
                .subscribe(function (data) {
                console.log(data, _this.registerForm.value);
                if (data) {
                    // this.router.navigate(['home']);
                    // 1st solution
                    ...
                    var postParams_1 = {
                        value: {
                            email: _this.registerForm.value.org_id,
                            password: _this.registerForm.value.org_password
                        }
                    };
                    _this.appService.organizationLogin(postParams_1).subscribe(function (resp) {
                        if (resp) {
                            sessionStorage.setItem('currentUserId', JSON.stringify(postParams_1.value));
...
module.exports = "<style>\n  .current-clikable-item {\n    color: #f71769 !important;\n  }\n</style>\n<header>\n  <div class=\"top-part\">\n    <div class=\"container\">\n      <div class=\"row\">\n        <div class=\"col-md-6 col-xs-6\">\n          <ul class=\"top-socila\">\n            <li><a href=\"javascript:void(0);\"><i class=\"fab fa-facebook-f\"></i></a></li>\n            <li><a href=\"javascript:void(0);\"><i class=\"fab fa-twitter\"></i></a></li>\n            <li><a href=\"javascript:void(0);\"><i class=\"fab fa-instagram\"></i></a></li>\n          </ul>\n        </div>\n        <div class=\"col-md-6 col-xs-6 log-in text-right\">\n          <div class=\"dropdown\">\n            <div style=\"display: flex;align-items: center;\" *ngIf=\"organizationList\">\n              <i class=\"fas fa-users\" style=\"font-size:24px;\"></i>\n              <span style=\"font-size:20px;\">\n                <b>&nbsp;&nbsp;Hi, {{organizationList.name }}</b>\n              </span>\n            </div>\n            <div class=\"dropdown-content dropdown-menu-right\">\n              <li class=\"dd-item\">\n                <a class=\"nav-link\" routerLink=\"/orgdashboard/\" routerLinkActive=\"current-clikable-item\"\n                   [routerLinkActiveOptions]=\"{exact:true}\">Dashboard</a>\n              </li>\n              <li class=\"dd-item\">\n                <a class=\"nav-link\" routerLink=\"/fest-upload-form/\" routerLinkActive=\"current-clikable-item\"\n                   [routerLinkActiveOptions]=\"{exact:true}\">Create Fest</a>\n              </li>\n              <li class=\"dd-item\">\n                <a href=\"javascript:void(0);\" class=\"nav-link\" routerLinkActive=\"current-clikable-item\"\n                   [routerLinkActiveOptions]=\"{exact:true}\" (click)=\"this.authenticationServiceFn.logout()\">Logout</a>\n              </li>\n            </div>\n          </div>\n        </div>\n\n      </div>\n    </div>\n  </div>\n  <div class=\"logo-sec\">\n    <div class=\"container\">\n      <div class=\"row\">\n        <div class=\"col-md-2 col-xs-2 col-sm-2 col-md-offset-1 logo-part\">\n          <a routerLink=\"/\"><img src=\"assets/images/logo2.png\" alt=\"\"></a>\n        </div>\n        <div class=\"col-md-9 text-right\">\n          <div id=\"navigation\">\n            <nav>\n              <div class=\"collapse navbar-collapse justify-content-end\" id=\"nav-content\">\n                <ul class=\"navbar-nav navbar-right\" id=\"nav\">\n                  <li class=\"nav-item\">\n                    <a class=\"nav-link\" routerLink=\"/\" routerLinkActive=\"current-clikable-item\"\n                       [routerLinkActiveOptions]=\"{exact:true}\">Home</a>\n                  </li>\n                  <li class=\"nav-item\">\n                    <a class=\"nav-link\" routerLink=\"/fest/\" routerLinkActive=\"current-clikable-item\"\n                       [routerLinkActiveOptions]=\"{exact:true}\">Fests</a>\n                  </li>\n                  <li class=\"nav-item\">\n                    <a class=\"nav-link\" routerLink=\"/organizations/\" routerLinkActive=\"current-clikable-item\"\n                       [routerLinkActiveOptions]=\"{exact:true}\">organizations</a>\n                  </li>\n                  <li class=\"nav-item\"><a href=\"#contact\">contact us</a></li>\n                  <li class=\"nav-item\"><a href=\"#map-sec\">location</a></li>\n                </ul>\n              </div>\n            </nav>\n          </div>\n        </div>\n\n      </div>\n    </div>\n  </div>\n</header>\n"
...
var OrganizationheaderComponent = /** @class */ (function () {
    function OrganizationheaderComponent(appService, authenticationService) {
        ...
        this.appService = appService;
        this.authenticationService = authenticationService;
        this.gettingFestData = function () {
            _this.appService.specificOrganizationList().subscribe(function (data) {
                _this.organizationList = data['organization'];
                // localStorage.setItem('organization', JSON.stringify(this.organizationList));
            });
        };
    }
    Object.defineProperty(OrganizationheaderComponent.prototype, "authenticationServiceFn", {
        get: function () {
            return this.authenticationService;
        },
        enumerable: true,
...
var UserheaderComponent = /** @class */ (function () {
    ...
    Object.defineProperty(UserheaderComponent.prototype, "authenticationServiceFn", {
        get: function () {
            return this.authenticationService;
        },
        enumerable: true,
...
module.exports = __webpack_require__(/*! /Users/adityaprasanna/Desktop/Festify_WebApp/TicketBookingFrontEnd/src/main.ts */"./src/main.ts");
